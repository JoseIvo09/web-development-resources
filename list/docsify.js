! function() {
	...
	var H = function(o) {
			...
			return o && (e.__proto__ = o), ((e.prototype = Object.create(o && o.prototype)).constructor = e).prototype.getBasePath = function() {
				...
				return 0 <= i && (n = e.slice(i + 1), e = e.slice(0, i)), {
					path: e,
		...
		D = function(n) {
			...
			return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.getCurrentPath = function() {
				...
				void 0 === i && (i = d), p("click", function(e) {
					...
					n && "A" === n.tagName && !g(n.href) && (e.preventDefault(), n = n.href, window.history.pushState({
						key: n
					}, "", n), i({
						event: e,
						source: "navigate"
	...
	function ue(e) {
		...
		if (o)
			for (var t in i) !u.call(i, t) || f(n = o.getAttribute("data-" + a(t))) && (i[t] = "" === n || n);
			...
			return e.prototype.space = function(e) {
				...
				if (n) {
					...
					if (!this.options.pedantic && /^</.test(e)) {
						...
						var o = Ke(n[2], "()"); - 1 < o && (t = (0 === n[0].indexOf("!") ? 5 : 4) + n[1].length + o, n[2] = n[2].substring(0, o), n[0] = n[0].substring(0, t).trim(), n[3] = "")
					}
					var t, i = n[2],
						o = "";
				...
				if (o && (!o[1] || o[1] && ("" === i || this.rules.inline.punctuation.exec(i)))) {
					...
					for (a.lastIndex = 0; null != (o = a.exec(n));)
						if (t = this.rules.inline.strong.middle.exec(n.slice(0, o.index + 3))) return {
							type: "strong",
				...
				if (o && (!o[1] || o[1] && ("" === i || this.rules.inline.punctuation.exec(i)))) {
					...
					for (a.lastIndex = 0; null != (o = a.exec(n));)
						if (t = this.rules.inline.em.middle.exec(n.slice(0, o.index + 2))) return {
							type: "em",
							raw: e.slice(0, t[0].length),
	...
	var fn = function() {
			...
			return e.rules.get = function() {
				...
				else if (i && (o = this.tokenizer.def(e))) e = e.substring(o.raw.length), this.tokens.links[o.tag] || (this.tokens.links[o.tag] = {
					href: o.href,
					title: o.title
				});
				...
				if (this.tokens.links) {
					...
					if (0 < f.length)
						for (; null != (a = this.tokenizer.rules.inline.reflinkSearch.exec(u));) f.includes(a[0].slice(a[0].lastIndexOf("[") + 1, -1)) && (u = u.slice(0, a.index) + "[" + rn("a", a[0].length - 2) + "]" + u.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
				}
	...
	In.prototype.compileEmbed = function(e, n) {
		...
		var r, c, u, f, p, d, e = new Sn.Renderer,
			n = this.linkTarget,
			i = this.linkRel,
			a = this.router,
			o = this.contentBase,
		...
		return t.heading = e.heading = function(e, n) {
			...
			i = Tn(t.id || o), t = a.toURL(a.getCurrentPath(), {
				id: i
			});
	...
	var Qn, Jn = function(e) {
		...
		return e && (n.__proto__ = e), ((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype._loadSideAndNav = function(e, n, i, o) {
			...
			var o = this;
			void 0 === i && (i = d);
			var t, e, n, a, r, c, u, f = this.route.query,
				p = this.route.path;
